...
public class Log<T> extends AbstractBinaryExpression<T> {
    ...
    public Log(Expression<T> first, Expression<T> second, GenericType<T> typeObject) {
        super(first, second);

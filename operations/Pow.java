...
public class Pow<T> extends AbstractBinaryExpression<T> {
    ...
    public Pow(Expression<T> first, Expression<T> second, GenericType<T> typeObject) {
        super(first, second);
